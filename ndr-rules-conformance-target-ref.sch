...
<sch:pattern id="rule_9-8"><sch:title>Simple type definition is top-level</sch:title>
...
<sch:pattern id="rule_9-9"><sch:title>Simple type has data definition</sch:title>
  <sch:rule context="xs:simpleType">
    <sch:assert test="exists(xs:annotation/xs:documentation)">Rule 9-9: A simple type MUST be a [documented component].</sch:assert>
  </sch:rule>
</sch:pattern>
      
<sch:pattern id="rule_9-10"><sch:title>Simple type data definition is not empty</sch:title>
...
<sch:pattern id="rule_9-11"><sch:title>No list item type of xs:ID</sch:title>
...
<sch:pattern id="rule_9-12"><sch:title>No list item type of xs:IDREF</sch:title>
  <sch:rule context="xs:*[exists(@itemType)]">
...
<sch:pattern id="rule_9-13"><sch:title>No list item type of xs:anySimpleType</sch:title>
  <sch:rule context="xs:*[exists(@itemType)]">
...
<sch:pattern id="rule_9-14"><sch:title>No union member types of xs:ID</sch:title>
...
<sch:pattern id="rule_9-15"><sch:title>No union member types of xs:IDREF</sch:title>
  <sch:rule context="xs:*[exists(@memberTypes)]">
...
<sch:pattern id="rule_9-16"><sch:title>No union member types of xs:IDREFS</sch:title>
  <sch:rule context="xs:*[exists(@memberTypes)]">
...
<sch:pattern id="rule_9-17"><sch:title>No union member types of xs:anySimpleType</sch:title>
  <sch:rule context="xs:*[exists(@memberTypes)]">
...
<sch:pattern id="rule_9-18"><sch:title>No simple type disallowed derivation</sch:title>
  <sch:rule context="xs:simpleType">
    <sch:assert test="empty(@final)">Rule 9-18: An element xs:simpleType MUST NOT have an attribute {}final.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_9-19"><sch:title>Enumeration has data definition</sch:title>
...
<sch:pattern id="rule_9-20"><sch:title>Enumeration data definition is not empty</sch:title>
...
<sch:pattern id="rule_9-21"><sch:title>Complex type definitions is top-level</sch:title>
...
<sch:pattern id="rule_9-22"><sch:title>Complex type has data definition</sch:title>
  <sch:rule context="xs:complexType">
    <sch:assert test="exists(xs:annotation/xs:documentation)">Rule 9-22: A complex type MUST be a [documented component].</sch:assert>
  </sch:rule>
</sch:pattern>
      
<sch:pattern id="rule_9-23"><sch:title>Complex type data definition is not empty</sch:title>
...
<sch:pattern id="rule_9-24"><sch:title>No mixed content on complex type</sch:title>
...
<sch:pattern id="rule_9-25"><sch:title>No mixed content on complex content</sch:title>
...
<sch:pattern id="rule_9-26"><sch:title>Complex type content is explicitly simple or complex</sch:title>
  <sch:rule context="xs:complexType">
...
<sch:pattern id="rule_9-27"><sch:title>Complex content uses extension</sch:title>
...
<sch:pattern id="rule_9-29"><sch:title>Simple content uses extension</sch:title>
...
<sch:pattern id="rule_9-32"><sch:title>No complex type disallowed substitutions</sch:title>
  <sch:rule context="xs:complexType">
    <sch:assert test="empty(@block)">Rule 9-32: An element xs:complexType MUST NOT have an attribute {}block.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_9-33"><sch:title>No complex type disallowed derivation</sch:title>
  <sch:rule context="xs:complexType">
    <sch:assert test="empty(@final)">Rule 9-33: An element xs:complexType MUST NOT have an attribute {}final.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_9-34"><sch:title>Element declaration is top-level</sch:title>
...
<sch:pattern id="rule_9-35"><sch:title>Element declaration has data definition</sch:title>
  <sch:rule context="xs:element[exists(@name)]">
...
<sch:pattern id="rule_9-36"><sch:title>Element declaration data definition is not empty</sch:title>
...
<sch:pattern id="rule_9-42"><sch:title>No element disallowed substitutions </sch:title>
...
<sch:pattern id="rule_9-43"><sch:title>No element disallowed derivation</sch:title>
  <sch:rule context="xs:element">
...
<sch:pattern id="rule_9-46"><sch:title>Element declaration is nillable</sch:title>
...
<sch:pattern id="rule_9-49"><sch:title>Attribute declaration data definition is not empty</sch:title>
...
<sch:pattern id="rule_9-54"><sch:title>No attribute default values</sch:title>
...
<sch:pattern id="rule_9-55"><sch:title>No attribute fixed values</sch:title>
  <sch:rule context="xs:attribute">
    <sch:assert test="empty(@fixed)">Rule 9-55: An element xs:attribute MUST NOT have an attribute {}fixed.</sch:assert>
  </sch:rule>
</sch:pattern>
              
<sch:pattern id="rule_9-56"><sch:title>No use of element xs:notation</sch:title>
...
<sch:pattern id="rule_9-58"><sch:title>No xs:all</sch:title>
  <sch:rule context="xs:all">
    <sch:assert test="false()">Rule 9-58: The schema MUST NOT contain the element xs:all</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_9-59"><sch:title>xs:sequence must be child of xs:extension</sch:title>
...
<sch:pattern id="rule_9-61"><sch:title>No xs:choice</sch:title>
...
<sch:pattern id="rule_9-67"><sch:title>Referenced attribute defined by conformant schemas</sch:title>
...
<sch:pattern id="rule_9-68"><sch:title>Schema uses only known attribute groups</sch:title>
...
<sch:pattern id="rule_9-69"><sch:title>No use of xs:any</sch:title>
  <sch:rule context="xs:any">
    <sch:assert test="false()">Rule 9-69: The schema MUST NOT contain the element xs:any.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_9-70"><sch:title>No use of xs:anyAttribute</sch:title>
...
<sch:pattern id="rule_9-78"><sch:title>xs:appinfochildren are comments, elements, or whitespace</sch:title>
...
<sch:pattern id="rule_9-81"><sch:title>Schema has data definition</sch:title>
  <sch:rule context="xs:schema">
    <sch:assert test="exists(xs:annotation/xs:documentation)">Rule 9-81: A schema document element MUST be a [documented component].</sch:assert>
  </sch:rule>
</sch:pattern>
      
<sch:pattern id="rule_9-82"><sch:title>Schema data definition is not empty</sch:title>
  <sch:rule context="xs:schema/xs:annotation/xs:documentation[                          . is (../../xs:annotation/xs:documentation)[1]]">
    <sch:assert test="string-length(normalize-space(string-join(text(), ''))) &gt; 0">Rule 9-82: A data definition MUST NOT be empty.</sch:assert>
  </sch:rule>
</sch:pattern>
...
<sch:pattern id="rule_9-84"><sch:title>Target namespace is absolute URI</sch:title>
  <sch:rule context="xs:schema[exists(@targetNamespace)]">
    <sch:report test="true()">Rule 9-84: The value of the attribute targetNamespace MUST match the production &lt;absolute-URI&gt; as defined by RFC 3986.</sch:report>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-85"><sch:title>Schema must have version</sch:title>
  <sch:rule context="xs:schema">
    <sch:assert test="exists(@version)">Rule 9-85: An element xs:schema MUST have an attribute {}version.</sch:assert>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-86"><sch:title>Schema version must not be empty</sch:title>
  <sch:rule context="xs:schema[exists(@version)]">
    <sch:assert test="string-length(normalize-space(@version)) &gt; 0">Rule 9-86: An attribute version owned by an element xs:schema MUST NOT be empty.</sch:assert>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-87"><sch:title>No disallowed substitutions</sch:title>
  <sch:rule context="xs:schema">
    <sch:assert test="empty(@blockDefault)">Rule 9-87: An element xs:schema MUST NOT have an attribute {}blockDefault.</sch:assert>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-88"><sch:title>No disallowed derivations</sch:title>
  <sch:rule context="xs:schema">
    <sch:assert test="empty(@finalDefault)">Rule 9-88: An element xs:schema MUST NOT have an attribute {}finalDefault.</sch:assert>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-89"><sch:title>No use of xs:redefine</sch:title>
  <sch:rule context="xs:redefine">
    <sch:assert test="false()">Rule 9-89: The schema MUST NOT contain the element xs:redefine.</sch:assert>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-90"><sch:title>No use of xs:include</sch:title>
  <sch:rule context="xs:include">
    <sch:assert test="false()">Rule 9-90: The schema MUST NOT contain the element xs:include.</sch:assert>
  </sch:rule>
</sch:pattern>
          
<sch:pattern id="rule_9-91"><sch:title>xs:import must have namespace</sch:title>
  <sch:rule context="xs:import">
    <sch:assert test="exists(@namespace)">Rule 9-91: An element xs:import MUST have an attribute {}namespace.</sch:assert>
  </sch:rule>
</sch:pattern>
...
<sch:pattern id="rule_10-18"><sch:title>External adapter type uses sequence</sch:title>
  <sch:rule context="xs:complexType[exists(@appinfo:externalAdapterTypeIndicator)                                     and exists(xs:complexContent/xs:extension)]">
...
<sch:pattern id="rule_10-19"><sch:title>Name of code type ends in "CodeType"</sch:title>
  <sch:rule context="xs:complexType">
    ...
    <sch:assert test="$has-code-type-name = $has-code-type-base">Rule 10-19: A complex type definition MUST have a {name} that ends in 'CodeType' if and only if it has a {base type definition} of a code type or code simple type.</sch:assert>
  </sch:rule>
</sch:pattern>
                
<sch:pattern id="rule_10-20"><sch:title>Association types is derived from association type</sch:title>
  <sch:rule context="xs:complexType">
    ...
    <sch:assert test="$is-association-type = $has-association-base-type">Rule 10-20: A type MUST have a association type name if and only if it is derived from an association type.</sch:assert>
  </sch:rule>
</sch:pattern>
              
<sch:pattern id="rule_10-21"><sch:title>Association element type is an association type</sch:title>
  <sch:rule context="xs:element[exists(@name)]">
...
<sch:pattern id="rule_10-22"><sch:title>Augmentable type has augmentation point element</sch:title>
  <sch:rule context="xs:complexType[                        exists(@name[                          not(ends-with(., 'MetadataType'))                          and not(ends-with(., 'AugmentationType'))])                        and empty(@appinfo:externalAdapterTypeIndicator)                        and exists(child::xs:complexContent)]">
    ...
    <sch:assert test="xs:complexContent/xs:extension/xs:sequence/xs:element[                         @ref[resolve-QName(., ..) = $augmentation-point-qname]]">Rule 10-22: An augmentable type MUST contain an element use of its augmentation point element.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_10-23"><sch:title>Augmentable type has at most one augmentation point element</sch:title>
  <sch:rule context="xs:complexType[                        exists(@name[                          not(ends-with(., 'MetadataType'))                          and not(ends-with(., 'AugmentationType'))])                        and empty(@appinfo:externalAdapterTypeIndicator)                        and exists(child::xs:complexContent)]">
    <sch:let name="augmentation-point-qname" value="QName(nf:get-target-namespace(.),                           replace(./@name, 'Type$', 'AugmentationPoint'))"/>
    <sch:assert test="count(xs:complexContent/xs:extension/xs:sequence/xs:element[                               @ref[resolve-QName(., ..) = $augmentation-point-qname]]) &lt;= 1">Rule 10-23: An augmentable type MUST contain no more than one element use of its augmentation point element.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_10-24"><sch:title>Augmentation point corresponds to augmentable type</sch:title>
  <sch:rule context="xs:element[exists(@name[                                  matches(., 'AugmentationPoint$')])]">
    <sch:let name="element-name" value="@name"/>
    <sch:assert test="exists(                         parent::xs:schema/xs:complexType[                           @name = replace($element-name, 'AugmentationPoint$', 'Type')                           and exists(@name[                                   not(ends-with(., 'MetadataType'))                                   and not(ends-with(., 'AugmentationType'))])                                 and empty(@appinfo:externalAdapterTypeIndicator)                                 and exists(child::xs:complexContent)])">Rule 10-24: A schema document containing an augmentation point element declaration MUST also contain a corresponding augmentable type definition.</sch:assert>
  </sch:rule>
</sch:pattern>
...
<sch:pattern id="rule_10-27"><sch:title>Augmentation point element may only be referenced by its type</sch:title>
  <sch:rule context="xs:complexType//xs:element[exists(@ref[                        matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]">

    <sch:assert test="QName(nf:get-target-namespace(ancestor::xs:complexType[1]), ancestor::xs:complexType[1]/@name)                       = QName(namespace-uri-from-QName(resolve-QName(@ref, .)),                 replace(local-name-from-QName(resolve-QName(@ref, .)), 'AugmentationPoint$', 'Type'))">Rule 10-27: An augmentation point element MUST only be referenced by its corresponding type.</sch:assert>
  </sch:rule>
</sch:pattern>            
            
<sch:pattern id="rule_10-28"><sch:title>Augmentation point reference is optional</sch:title>
  <sch:rule context="xs:complexType//xs:element[exists(@ref[                            matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]">
    <sch:assert test="exists(@minOccurs) and xs:integer(@minOccurs) = 0">Rule 10-28: An augmentation point element particle MUST have attribute minOccurs equal to 0.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_10-29"><sch:title>Augmentation point reference is unbounded</sch:title>
  <sch:rule context="xs:complexType//xs:element[exists(@ref[                            matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]">
    <sch:assert test="exists(@maxOccurs) and string(@maxOccurs) = 'unbounded'">Rule 10-29: An augmentation point element particle MUST have attribute maxOccurs set to unbounded.</sch:assert>
  </sch:rule>
</sch:pattern>
            
<sch:pattern id="rule_10-30"><sch:title>Augmentation point reference must be last particle</sch:title>
  <sch:rule context="xs:complexType//xs:element[exists(@ref[                            matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]">
    <sch:assert test="empty(following-sibling::*)">Rule 10-30: An augmentation point element particle MUST be the last element occurrence in its content model.</sch:assert>
  </sch:rule>
</sch:pattern>
