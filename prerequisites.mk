...
$(synced_token_schematron_cli):
	if [[ -d $(repo_dir_schematron_cli) ]]; \
	then cd $(repo_dir_schematron_cli); \
	     git pull; \
	else mkdir -p $(dir $(repo_dir_schematron_cli)); \
	     git clone $(repo_schematron_cli) $(repo_dir_schematron_cli); \
	fi
	$(call touch,$@)

$(setup_token_schematron_cli): $(synced_token_schematron_cli) $(setup_token_wrtools_core)
